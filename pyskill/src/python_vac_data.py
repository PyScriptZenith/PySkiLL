...
# Преобразуем данные в словарь, где ключ - слово, значение - частота упоминания
...
python_hard_skills = ['sql', 'bash', 'linux', 'pandas', 'postgresql', 'docker', 'git',
                'django', 'numpy', 'api', 'powershell', 'ci', 'ml', 'rest', 'субд', 'fastapi',
                'flask', 'cd', 'mysql', 'html',
                'clickhouse', 'javascript', 'ansible', 'gitlab', 'kubernetes', 'css', 'jenkins',
                'pytest', 'scipy', 'vba', 'golang',
                'matplotlib', 'nginx', 'selenium', 'jira', 'pytorch', 'oracle', 'google', 'grafana', 'http',
                'unix', 'tcp', 'zabbix', 'airflow', 'spark', 'postgres', 'matlab', 'kafka', 'tensorflow',
                'confluence', 'sklearn', 'prometheus', 'powerbi', 'groovy', 'redis', 'aiohttp',
                'asyncio', 'json', 'scikit', 'elk', 'postman',
                ]
